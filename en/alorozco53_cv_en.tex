...
\cventry{2019--}{Master of Science Degree}
        ...
        {Supervised by Prof \href{http://www.reirab.com}{Reihaneh Rabbany}; \textit{Current GPA: 3.96/4.0}}
        {Computer Science}
...
\cventry{2020}{Data Science Intern at \href{https://ueat.io/en/}{UEAT}}
        {Paid Job}
...
\cvlistdoubleitem{Science (in general)}{Running}
\cvlistdoubleitem{Soccer}{American football}
\cvlistdoubleitem{Chess}{Music}
\cvlistdoubleitem{Dancing}{Exercising}
