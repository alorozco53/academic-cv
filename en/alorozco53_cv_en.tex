%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[8pt,a4paper,sans]{moderncv} %% Font sizes: 10, 11, or 12; paper sizes: a4paper, letterpaper, a5paper,
...
\cvitem{Mobile No.}{+1 (438) 228-8011}

\section{Areas of Interest}
\cvlistitem{Federated Learning}
\cvlistitem{Continual Learning}
\cvlistitem{Distribution Shifts}
...
\cventry{2022}{Machine Learning (NLP) Intern at \href{https://korbit.ai}{Korbit AI}}
        {Paid Job}
...
\cventry{2021}{Deep Learning Intern at \href{https://linguai.co}{LinguAI}}
        {Paid Job}
...
\cvlistdoubleitem{PyTorch}{Tensorflow}
\cvlistdoubleitem{JAX}{Prolog}
\cvlistdoubleitem{C++}{NumPy}
\cvlistdoubleitem{SciPy}{R}
\cvlistdoubleitem{Scikit Learn}{spaCy}
